...
public:
    ...
    void ProcessKeyboard(CameraGL_Movement direction, float deltaTime)
    {
...
private:
    // calculates the front vector from the CameraGL's (updated) Euler Angles
    void updateCameraGLVectors()
    {
